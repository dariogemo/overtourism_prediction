...
very_dates = dates[:, -1, :]
very_true = true[23::24]
very_pred = pred[23::24]
...
final_df = pd.DataFrame(very_pred, index = full_datetimes[:len(very_pred)], columns = ['Predicted'])
